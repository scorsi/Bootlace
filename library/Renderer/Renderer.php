...
use Bootlace\Renderer\Exception\TemplateNotFoundException;
use Bootlace\Renderer\Plugin\PluginContainer;
use Bootlace\Renderer\Plugin\PluginInterface;
...
class Renderer
{
     ...
     * or echo the output
     *
     * @return string|null: depending of the $toString
     */
    ...
    {
        $files = glob(static::$conf['cache_dir'] . "*.template.php");
     ...
     */
    public static function registerPlugin(PluginInterface $plugin, $name = '')
    {
    ...
    protected function checkTemplate($template)
    {
        ...
        if ($template[0] == '/') {
            ...
            $parsedTemplateFilepath = $this->config['cache_dir'] . $templateName . "." . md5($templateDirectory . serialize($this->config['checksum'])) . '.template.php';
    ...
    protected function checkString($string)
    {
        ...
        $parsedTemplateFilePath = $this->config['cache_dir'] . $templateName . '.s.template.php';
        $templateFilePath = '';
        $templateBasedir = '';
